...
export const WhatsAppButton: React.FC = () => {
  ...
  return (
    <a
      ...
      aria-label="WhatsApp"
      className="fixed bottom-6 right-6 md:bottom-8 md:right-8 z-50 bg-[#25D366] text-white p-3 md:p-4 rounded-full shadow-2xl hover:scale-110 hover:rotate-12 transition-all duration-300 group"
    >
